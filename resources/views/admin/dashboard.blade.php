    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <div class="bg-white p-6 rounded-lg flex items-center justify-between">
            <div>
                ...
                <h2 class="text-2xl font-bold text-gray-900">{{ $totalCars }}</h2>
            </div>
        ...
        <div class="bg-white p-6 rounded-lg flex items-center justify-between">
            <div>
                ...
                <h2 class="text-2xl font-bold text-gray-900">{{ $todayOrders }}</h2>
            </div>
        ...
        <div class="bg-white p-6 rounded-lg flex items-center justify-between">
            <div>
                ...
                <h2 class="text-2xl font-bold text-gray-900">Rp {{ number_format($totalRevenue) }}</h2>
            </div>
        ...
        <div class="bg-white p-6 rounded-lg flex items-center justify-between">
            <div>
                ...
                <h2 class="text-2xl font-bold text-gray-900">{{ $newTestimonials }}</h2>
            </div>
