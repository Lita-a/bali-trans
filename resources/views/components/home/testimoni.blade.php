    ...
    <div class="container mx-auto px-6">
        ...
        <div class="max-w-2xl mx-auto mb-12">
            ...
            <form id="testimonialForm" action="{{ route('testimoni.store') }}" method="POST" class="space-y-4">
                ...
                <div class="flex justify-center gap-2 mb-2">
                    @for($i=1; $i<=5; $i++)
                    <svg data-value="{{ $i }}" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 cursor-pointer text-gray-400 rating-star" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="relative">
            <div id="testimonial-carousel" class="flex gap-6 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-6">
                ...
                <div class="shrink-0 w-80 p-8 rounded-2xl snap-start text-center"
            ...
            <button id="prevBtn" class="absolute left-0 top-1/2 -translate-y-1/2 bg-orange-500 text-white p-3 rounded-full shadow-lg">‹</button>
            <button id="nextBtn" class="absolute right-0 top-1/2 -translate-y-1/2 bg-orange-500 text-white p-3 rounded-full shadow-lg">›</button>
        </div>
    </div>
