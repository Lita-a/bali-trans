<section class="py-24 bg-gray-100 overflow-hidden">
    <div class="container mx-auto px-6 text-center space-y-6">
        <h2 class="text-4xl font-bold text-gray-900 mb-3">Sewa Mobil Impian Anda Sekarang!</h2>
        <p class="text-center text-gray-600 mb-14 max-w-2xl mx-auto">
            Pilih mobil favorit Anda dan nikmati liburan di Bali dengan pelayanan terbaik dari Bali Trans.
        </p>
        <div class="flex flex-col sm:flex-row justify-center gap-4 mt-6">
            <a href="{{ url('/cars') }}"
                class="btn-black-orange px-6 py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl transition transform hover:-translate-y-1">
                Lihat Koleksi Mobil
            </a>

            <a href="https://wa.me/6281234567890" target="_blank"
                class="bg-green-500 hover:bg-green-600 text-white px-6 py-4 rounded-lg font-semibold shadow-lg flex items-center justify-center gap-2 transition transform hover:-translate-y-1">
